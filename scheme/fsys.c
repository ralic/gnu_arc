...
static sexp arc_stat(sexp ctx, sexp path)
{
  ...
  if (stat(sexp_string_data(path), &fattr) == 0) {
    return sexp_vector(ctx, 13,
                       sexp_make_integer(fattr.st_dev),
                       sexp_make_integer(fattr.st_ino),
                       sexp_make_integer(fattr.st_mode),
                       sexp_make_integer(fattr.st_nlink),
                       sexp_make_integer(fattr.st_uid),
                       sexp_make_integer(fattr.st_gid),
                       sexp_make_integer(fattr.st_rdev),
                       sexp_make_integer(fattr.st_size),
                       sexp_make_integer(fattr.st_atime),
                       sexp_make_integer(fattr.st_mtime),
                       sexp_make_integer(fattr.st_ctime),
                       sexp_make_integer(fattr.st_blksize),
                       sexp_make_integer(fattr.st_blocks));
