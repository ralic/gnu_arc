...
;; $Id: task-c-compile-cygwin.scm,v 1.1 2003/04/23 18:46:42 eyestep Exp $


(arc:provide 'task-c-compile-cygwin)

(arc:log 'debug "loading 'c-compile' task [cygwin]")
...
(define <arc:c-compile-cygwin>
  (arc:make-class 
   '<arc:c-compile-cygwin>              ; name of the class
   ...
   `(
     ...
     (need-shared-build ,(lambda (self) #f))
